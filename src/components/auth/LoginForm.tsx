    ...
    <Card className="glass-card border-none w-full max-w-md mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <NavLink to="/forgot-password" className="text-sm text-brand-purple hover:underline">
                Forgot password?
              </NavLink>
            </div>
            <Input
      ...
      <CardFooter className="flex justify-center pb-8">
        <p className="text-sm text-muted-foreground">
          ...
          <NavLink to="/signup" className="text-brand-purple font-medium hover:underline">
            Sign up
          </NavLink>
        </p>
      </CardFooter>
